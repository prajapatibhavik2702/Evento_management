<x-organiser-layout>
    <x-slot name="title">Organiser - ajhsfvg  UpdateEvent</x-slot>
    ...
    <div class="container m-t-20">
        ...
        <div class="wrap-login101 p-l-40 p-r-40 p-t-40 p-b-40" style="margin-left: 15px">
            <form class="login100-form validate-form flex-sb flex-w" action="{{ route('organiser.events.update',$events->id) }}" method="post" enctype="multipart/form-data">
                @csrf
