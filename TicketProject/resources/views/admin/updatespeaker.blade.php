<x-admin-layout>
    <x-slot name="title">Admin - UpdateSpeaker</x-slot>
    ...
    <div class="container m-t-20">
        ...
        <div class="wrap-login100 p-l-40 p-r-40 p-t-40 p-b-40" style="margin-left: 25%">
            ...
            <form class="login100-form validate-form flex-sb flex-w" action="{{ route('admin.speaker.update',$speakers->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="wrap-input100 validate-input m-b-30" data-validate="Name is required">
                    <input class="input100" type="text" name="name" placeholder="Speaker Name" value={{ $speakers->name}}>
                ...
                <div class="wrap-input100 validate-input m-b-30" data-validate="Description is required">
                    <input class="input100" type="text" name="description" placeholder="Speaker Description" value={{ $speakers->description}}>
                    <span class="focus-input100"></span>
                    {{-- validation error --}}
                        @error('description')
                            <span class="text-danger">{{ $message }}</span>
