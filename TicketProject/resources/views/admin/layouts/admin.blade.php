...
<head>
    ...
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="{{ asset('loginfrontend/vendor/bootstrap/css/bootstrap-grid.min.css') }}"/>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/css/spur.css') }}">
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.7.3/Chart.bundle.min.js"></script>
    <script src="{{ asset('frontend/js/chart-js-config.js')}}"></script>
...
<script src="{{ asset('frontend/js/spur.js') }}"></script>
@stack('scripts')
